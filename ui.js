...
L = (function(lang) {
    return $.extend(true,
        $.extend(true, { 'lang': lang }, i18n['ru']),
        i18n[lang]);
})($.getRequestParameter('lang') || 'ru'),
...
var q=document.getElementById("ValueQ").value;
var a=document.getElementById("ValueA").value;
var v=document.getElementById("ValueV").value;
var qq=document.getElementById("ValueQQ").value;
...
var command=document.getElementById("input-program").value+q+","+a+","+v+","+qq+"\n";

document.getElementById("input-program").value = command;
}
...
var command=q+","+a+","+v+","+qq+"\n";

program = program.split(command).join("");
document.getElementById("input-program").value = program;
}
